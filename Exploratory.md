...
weather_df %>% 
  ...
  summarize(
    ...
    mean_prcp = mean (prcp, na_rm = TRUE),
    median_tmin = median(tmin, na_rm = TRUE)
  )
```
...
This is a dtaframe! So we can make a plot.
...
<img src="Exploratory_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />
...
Reminder: sometimes your resuolts are easier to read in antoher format.
...
<img src="Exploratory_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />
What about window functions Ranking function the coldest day =1
...
THe colodest in the bottom

``` r
weather_df %>% 
  group_by(name,month) %>% 
  mutate(temp_rank = desc(tmax))
```
    ...
    ##  1 CentralPark_NY USW00094728 2017-01-01     0   8.9   4.4 2017-01-01      -8.9
    ##  2 CentralPark_NY USW00094728 2017-01-02    53   5     2.8 2017-01-01      -5  
    ##  3 CentralPark_NY USW00094728 2017-01-03   147   6.1   3.9 2017-01-01      -6.1
    ##  4 CentralPark_NY USW00094728 2017-01-04     0  11.1   1.1 2017-01-01     -11.1
    ##  5 CentralPark_NY USW00094728 2017-01-05     0   1.1  -2.7 2017-01-01      -1.1
    ##  6 CentralPark_NY USW00094728 2017-01-06    13   0.6  -3.8 2017-01-01      -0.6
    ##  7 CentralPark_NY USW00094728 2017-01-07    81  -3.2  -6.6 2017-01-01       3.2
    ##  8 CentralPark_NY USW00094728 2017-01-08     0  -3.8  -8.8 2017-01-01       3.8
    ##  9 CentralPark_NY USW00094728 2017-01-09     0  -4.9  -9.9 2017-01-01       4.9
    ## 10 CentralPark_NY USW00094728 2017-01-10     0   7.8  -6   2017-01-01      -7.8
    ## # … with 1,085 more rows
...
weather_df %>% 
  ...
  summarize(temp_change_max =max(temp_change,na.rm=TRUE),
